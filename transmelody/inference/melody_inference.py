...
from transmelody.models.melody_transformer import (STEPS_PER_BAR, FeatureConfig, decode_rhythm_modes,
    decode_segment_events, save_segment_prediction_midi)
from transmelody.grid.musical_timeline import canonicalize_grid
from transmelody.grid.tempo_map import build_tempo_segments, save_tempo_map_midi, tempo_events
...
def decode_prediction(outputs, features: torch.Tensor, config: FeatureConfig,
    ...
    if "note_event_onset" in outputs:
        from transmelody.models.musical_event_decoding import select_event_grids
