...
from project_settings import INTEGER_BPM_SNAP_TOLERANCE, PROJECT_PPQ
...
def build_grid(
    ...
    *,
    ...
    if ppq == PROJECT_PPQ and beats_per_bar == 4:
        from tempo_region_grid import apply_detected_tempo_regions
        from tempo_region_grid import multiply_grid_tempo
