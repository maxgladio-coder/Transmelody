...
from transmelody.models.melody_transformer import FeatureConfig, MelodyTransformer, ModelConfig
...
def main():
    ...
    report = {'checkpoint': str(args.checkpoint.resolve()), 'checkpoint_sha256': file_digest(args.checkpoint),
        ...
        'source_sha256': {name: file_digest(module_path(name)) for name in
