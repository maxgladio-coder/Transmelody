...
from melody_evaluation import note_counts, summarize_note_counts, file_digest, note_artifact_counts
...
def main() -> None:
    ...
    model.eval()
    from fusion_runtime import PitchFusionRuntime
    ...
    if args.pitch_context:
        from pitch_context import load_refiner
    ...
    for song_id, song in manifest.items():
        ...
        if refiner is not None:
            from pitch_context import note_inputs, refine_logits, replace_note_pitches, tonality_report
