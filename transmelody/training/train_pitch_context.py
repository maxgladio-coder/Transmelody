...
from transmelody.models.pitch_context import (PitchContextRefiner, note_inputs, context_features, refine_logits,
...
def main():
    ...
    provenance = {'base_checkpoint': str(args.base_checkpoint.resolve()), 'base_sha256': base_sha,
        ...
        'seed': args.seed, 'source_sha256': {name: file_digest(module_path(name))
