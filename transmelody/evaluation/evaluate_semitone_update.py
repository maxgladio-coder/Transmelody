...
from transmelody.audio.audio_audition import midi_notes_in_wav_time
...
from transmelody.grid.musical_timeline import tick_seconds, grid_tempo_events
...
def main():
    ...
    for value in args.checkpoint:
        ...
        del model, cp
    report['source_sha256'] = {p: file_digest(module_path(p)) for p in
