...
from melody_evaluation import (note_counts, summarize_note_counts, semitone_aba_counts,
...
from melody_inference import predict_outputs as old_outputs, decode_prediction, export_prediction
