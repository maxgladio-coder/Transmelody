...
from compare_melody_midi import compare, edit_patterns
from melody_evaluation import (_note_coordinates, note_counts, summarize_note_counts,
...
def main():
    ...
    report={'checkpoint_sha256':file_digest(args.checkpoint),'development_ids':ids,
        ...
        'source_sha256':{p:file_digest(Path(p)) for p in ('evaluate_note_artifacts.py','note_event_model.py','melody_transformer.py')}}
