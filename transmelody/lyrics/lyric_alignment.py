...
from transmelody.lyrics.pronunciation_labels import SCHEMA, digest, validate_labels
...
def coarse_phrase_times(audio: np.ndarray, sr: int, phrases: list[dict], device: torch.device) -> list[dict]:
    ...
    from transmelody.models.articulation_encoder import DEFAULT_ARTICULATION_MODEL, _load_encoder, clear_articulation_encoder_cache
