...
from transmelody.training.prepare_dataset import interpolate_with_extrapolation
from transmelody.config import PROJECT_PPQ
from transmelody.models.articulation_encoder import (
...
def build_song_cache(
    ...
    from transmelody.lyrics.pronunciation_labels import digest, load_reviewed, reviewed_targets
